...
In this vignette, we will demonstrate how to use the validation function:
...
-   `path`: path to the submissions file (or folder, for partitioned data) to
    ...
    The package contains 3 example files that can be used to test the
    ...
    -   `"2021-08-15_team-model.gz"` : should return multiple warnings
