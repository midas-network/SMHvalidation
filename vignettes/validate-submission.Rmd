...
format), to validate and visualize Scenario Modeling Hub submission.
...
lst_gs <- NULL
gh_info <- "https://raw.githubusercontent.com/midas-network/"
repo <- "covid19-scenario-modeling-hub/master/"
loc_file <- "data-locations/locations.csv"
pop_path <- paste0(gh_info, repo, loc_file)
...
path_test <- system.file("extdata", "2022-08-14_team-flu.csv",
                         package = "SMHvalidation")
repo <- "flu-scenario-modeling-hub/main/"
pop_path <- paste0(gh_info, repo, loc_file)
...
An other example is available for FLU submission (not compared to
