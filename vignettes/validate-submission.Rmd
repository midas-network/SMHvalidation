...
-   `js_def`: list containing the round specific and scenario
    information. It should be in the same output format as the function
    `json_metadata()` in the package `ScenarioModelingHub.data`. Some
    examples are also available in this package.
...
js_def <- system.file("extdata", "2022-01-09_metadata.json", package = "SMHvalidation")
...
```{r test1}
path_test <- system.file("extdata", "2022-01-09_team-model.csv", package = "SMHvalidation")
...
```{r test2}
path_test <- system.file("extdata", "2021-08-15_team-model.gz", package = "SMHvalidation")
js_def <- system.file("extdata", "2021-08-15_metadata.json", package = "SMHvalidation")
#js_def <- jsonlite::fromJSON(js_def)
validate_submission(path_test, lst_gs, pop_path, js_def)
```
...
```{r test3, error=TRUE}
path_test <- system.file("extdata", "2021-11-14_team-model.zip", package = "SMHvalidation")
js_def <- system.file("extdata", "2021-11-14_metadata.json", package = "SMHvalidation")
#js_def <- jsonlite::fromJSON(js_def)
validate_submission(path_test, lst_gs, pop_path, js_def)
```
...
```{r test4}
path_test <- system.file("extdata", "2022-08-14_team-flu.csv", package = "SMHvalidation")
pop_path <- "https://raw.githubusercontent.com/midas-network/flu-scenario-modeling-hub/main/data-locations/locations.csv"
js_def <- system.file("extdata", "2022-08-14_metadata.json", package = "SMHvalidation")
#js_def <- jsonlite::fromJSON(js_def)
